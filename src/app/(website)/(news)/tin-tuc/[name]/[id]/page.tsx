...
import { buildPostDetailMetadata } from '@/app/(website)/(SEO)/metadata/id/postDetailMetadata';
import { SITE_NAME, SITE_URL, postUrl, absoluteUrl, toMetaDescription } from '@/app/(website)/(SEO)/lib/seo';
