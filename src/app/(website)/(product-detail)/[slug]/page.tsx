...
import { StructuredData } from '@/app/(website)/(SEO)/metadata/structuredData';
import ClientPhoneDetailPage from '@/app/(website)/(product)/dien-thoai/[slug]/[id]/ClientPhoneDetailPage';
import ClientMacbookDetailPage from '@/app/(website)/(product)/macbook/[slug]/[id]/ClientMacbookDetailPage';
import ClientTabletDetailPage from '@/app/(website)/(product)/may-tinh-bang/[slug]/[id]/ClientTabletDetailPage';
import ClientWindowsDetailPage from '@/app/(website)/(product)/windows/[slug]/[id]/ClientWindowsDetailPage';
...
import { generatePhoneMetadata } from '@/app/(website)/(SEO)/metadata/id/phoneMetadata';
import { generateMacbookMetadata } from '@/app/(website)/(SEO)/metadata/id/macbookMetadata';
import { generateTabletMetadata } from '@/app/(website)/(SEO)/metadata/id/tabletMetadata';
import { generateWindowsMetadata } from '@/app/(website)/(SEO)/metadata/id/windowsMetadata';
