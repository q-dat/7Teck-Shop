...
const DB_NAME = "sub_note_product_store";
const DB_VERSION = 1;
const STORE_NAME = "sub_note_products";
const SETTINGS_KEY = "sub_note_global_settings";
const POSTED_KEY = "sub_note_posted_slots_v1";
const SCHEDULE_CONFIG_KEY = "sub_note_schedule_config_v1";
const SCHEDULE_ASSIGNMENTS_KEY = "sub_note_schedule_assignments_v1";
...
const createBackupFileName = (extension: "json" | "json.gz"): string => {
    ...
    return `sub-note-${safeDate}.${extension}`;
};
