  ...
  function mapGroupedTablets(data: GroupedTablet[]) {
    return data.map((group) => {
      ...
      return {
        ...
        ram: defaultVariant.tablet_catalog_id.t_cat_memory_and_storage.t_cat_ram ?? 'N/A',
        cpu: defaultVariant.tablet_catalog_id.t_cat_operating_system_and_cpu.t_cat_cpu_chip ?? 'N/A',
        ...
        variants: group.variants.map((v) => ({
          ...
          ram: v.tablet_catalog_id.t_cat_memory_and_storage.t_cat_ram ?? 'N/A',
          cpu: v.tablet_catalog_id.t_cat_operating_system_and_cpu.t_cat_cpu_chip ?? 'N/A',
          sale: v.tablet_sale,
