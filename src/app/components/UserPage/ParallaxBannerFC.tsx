...
const ParallaxBannerFC: React.FC = () => {
  ...
  const headline: BannerLayer = {
    ...
    children: (
      ...
      >
        <h1 className="text-[34px] font-semibold text-white md:text-6xl xl:text-[75px]">Thu cũ đổi mới, hỗ trợ giá lên đời.</h1>
  ...
  return (
    <section role="banner" aria-label="Banner quảng cáo Thu cũ đổi mới">
      <ParallaxBanner layers={[background, headline, foreground, gradientOverlay]} className="h-[400px] bg-gray-900 xl:aspect-[2/1] xl:h-[480px]" />
    </section>
  );
};
