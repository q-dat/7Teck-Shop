...
const TabletCatalogSchema = new Schema<ITabletCatalog>(
  ...
  { collection: 'tabletcatalogs' }
);

const TabletCatalogModel =
  (mongoose.models.TabletCatalog as Model<ITabletCatalog> | undefined) ?? mongoose.model<ITabletCatalog>('TabletCatalog', TabletCatalogSchema);
