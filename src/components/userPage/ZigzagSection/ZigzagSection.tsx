                    ...
                    {loading ? (
                      ...
                      mostViewedPhones.map((phone) => {
                        ...
                        return (
                          <div
                            key={phone?._id}
                            className="group relative flex h-full w-[200px] flex-col justify-between rounded-md border border-primary-lighter bg-white text-black"
                          >
                            ...
                            <div className="flex h-full w-full flex-col items-start justify-between p-1">
                              <div className="w-full">
                                ...
                                >
                                  ...
                                  <p className="text-prod-name-desktop font-medium group-hover:text-primary">Điện Thoại {phone?.name}</p>
                                </Link>
                                {/* Product Specifications */}
                                <div className="py-1 text-prod-name-desktop">
                                  {[
                              ...
                              <div className="w-full">
                                <p className="w-full text-prod-price-desktop">
