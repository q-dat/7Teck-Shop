...
export default function ClientPostSection({ news, tricks }: ClientPostSectionProps) {
  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-3 px-2 py-4 xl:px-desktop-padding">
        <div className="flex-1 border-t border-primary/60"></div>
        <div className="flex items-center gap-3">
          <FaRegNewspaper className="text-sm text-primary xl:text-2xl" />
          <h2 className="bg-primary bg-gradient-to-r bg-clip-text font-serif text-sm font-bold text-transparent xl:text-2xl">Tin Tức Công Nghệ</h2>
        </div>
        <div className="flex-1 border-t border-primary/60"></div>
      </div>
      <div
          ...
          {news.length > 0 && (
            <section role="region" aria-label="Bản tin mới nhất" className="mb-12">
              <div className="mb-6 flex flex-row items-center justify-between">
                <h1 className="text-lg font-bold tracking-tight text-white xl:text-2xl">Bản Tin</h1>
                <Link href={urlNews}>
